...
public class uiActions extends CommonOps
{
    ...
    public static void mouseHoverElements(WebElement elem1, WebElement elem2, WebElement elem3)
    {
          action.moveToElement(elem1).moveToElement(elem2).moveToElement(elem3).click().build().perform();
    }
